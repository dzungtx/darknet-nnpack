...
COMMON+= -DOPENCV
CFLAGS+= -DOPENCV
LDFLAGS+= -lwebrtc `pkg-config --libs opencv gstreamer-1.0 gstreamer-webrtc-1.0 gstreamer-sdp-1.0 libsoup-2.4 json-glib-1.0`
COMMON+= `pkg-config --cflags opencv gstreamer-1.0 gstreamer-webrtc-1.0 gstreamer-sdp-1.0 libsoup-2.4 json-glib-1.0`
endif
